document.write(`<footer class = "unselectable" onmouseenter = toggleOpacity("scrollTop") onmouseleave = toggleOpacity("scrollTop")>
  ...
  <nav class = "footerBar">
    ...
    <a title = "This Website has been developed by Yashdeep Singh Fauzdar for his School Project" href = ""> Copyright Disclaimer </a>
...
function toggleOpacity(id) {
  document.getElementById(id).style.opacity =
    1 - document.getElementById(id).style.opacity;
}
